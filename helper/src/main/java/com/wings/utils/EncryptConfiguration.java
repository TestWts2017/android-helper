...
/**
 * Purpose: Each of the specific storage types (like External storage tool) need its own
    ...
    public static class Builder {
        ...
        public Builder setEncryptContent(String ivx, String secretKey, byte[] salt) {
            ...
            try {
                ...
                LogHelper.e(TAG, "UnsupportedEncodingException");
            }
            ...
            try {
                ...
                LogHelper.e(TAG, "InvalidKeySpecException");
            } catch (NoSuchAlgorithmException e) {
                LogHelper.e(TAG, "NoSuchAlgorithmException");
            }
